        ...
        <SafeAreaView style={styles.container}>
                ...
                >
                    <View style={styles.topbar}>
                        ...
                        <View style={styles.viewcounter}>
                            <Text
                                style={{ color: "#F2F2F2", fontWeight: "bold" }}
                            >
                                <Image
                    ...
                    >
                        ...
                        >
                            We're telling your followers that you've started a
                            live video.
                        </Text>
                        <Text style={{ color: "#8B8B8D" }}>
                            Hang on! We're telling more followers to join your
                            video.
                        </Text>
            ...
            <View style={styles.bottombar}>
                <View style={styles.comment}>
                    ...
                    />
                    <Pressable
                        onPress={handleIconMenuPress}
                        style={{ marginLeft: 35 }}
                    >
                        <Image
                            source={require("../assets/image/Messanger.png")}
                        />
                    </Pressable>
                </View>

                <Image source={require("../assets/image/IconMenu.png")} />
                <Image source={require("../assets/image/Emoji.png")} />
                <Image source={require("../assets/image/FaceMasks.png")} />
                <Image source={require("../assets/image/Rectangle2.png")} />
            </View>
        </SafeAreaView>
    );
};
